...
class KotlinResolutionCallbacksImpl(
    ...
    override fun convertSignedConstantToUnsigned(argument: KotlinCallArgument, expectedType: UnwrappedType): IntegerValueTypeConstant? {
        if (!UnsignedTypes.isUnsignedType(expectedType)) return null
