...
private fun JavaType?.enhancePossiblyFlexible(
    ...
    val convertedType = this.toConeKotlinTypeWithoutEnhancement(session, javaTypeParameterStack)
    val enhanced = convertedType.enhanceConeKotlinType(session, qualifiers, index)
