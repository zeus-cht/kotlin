...
class FirExpressionsResolveTransformer(transformer: FirBodyResolveTransformer) : FirPartialBodyResolveTransformer(transformer) {
    ...
    override fun transformFunctionCall(functionCall: FirFunctionCall, data: ResolutionMode): CompositeTransformResult<FirStatement> {
        ...
        val completeInference =
            try {
                ...
                checkIfInvoke(completionResult)
    ...
    private fun checkIfInvoke(functionCall: FirFunctionCall) : FirFunctionCall {
        ...
        return if (resolvedSymbol.callableId.isInvoke()) {
            functionCall.transformCalleeReference(
    ...
    override fun transformCallableReferenceAccess(
        ...
        val transformedLHS = explicitReceiver?.transformSingle(this, ResolutionMode.ContextIndependent)
