...
open class FirStaticCallablesScope(protected val delegateScope: FirScope) : FirScope() {

    override fun processClassifiersByName(name: Name, processor: (FirClassifierSymbol<*>) -> Unit) {}

    final override fun processFunctionsByName(
        name: Name,
    ...
    final override fun processPropertiesByName(
        name: Name,
