...
class JvmRuntimeTypes(module: ModuleDescriptor, private val languageVersionSettings: LanguageVersionSettings) {
    ...
    private val useOptimizedReferenceSuperClasses = languageVersionSettings.apiVersion >= ApiVersion.KOTLIN_1_4
    ...
    fun getSupertypesForFunctionReference(
        ...
        val superClass = if (!isBound || useOptimizedReferenceSuperClasses) functionReferenceImpl else functionReference
    ...
    fun getSupertypeForPropertyReference(descriptor: VariableDescriptorWithAccessors, isMutable: Boolean, isBound: Boolean): KotlinType {
        ...
        val classes = when {
            !isBound || useOptimizedReferenceSuperClasses -> if (isMutable) mutablePropertyReferenceImpls else propertyReferenceImpls
