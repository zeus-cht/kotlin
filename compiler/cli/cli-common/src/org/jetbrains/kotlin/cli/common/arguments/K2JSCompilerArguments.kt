...
class K2JSCompilerArguments : CommonCompilerArguments() {
    ...
    @Argument(value = "-Xir-print-reachability-info", description = "Print declarations' reachability info to stdout during performing DCE")
    var irPrintReachabilityInfo: Boolean by FreezableVar(false)
